...
public class Rest_Info_Image_Fragment_3 extends Fragment {
	...
	public static Rest_Info_Image_Fragment_3 newInstance(int sectionNumber) {
		Rest_Info_Image_Fragment_3 fragment = new Rest_Info_Image_Fragment_3();
	...
	public Rest_Info_Image_Fragment_3() {
	}
			...
			try {
				...
				if (jsonMainNode != null) {
					for (int i = 0; i < jsonMainNode.length(); i++) {
						...
						String temp_s = jsonChildNode.getString("image3");
