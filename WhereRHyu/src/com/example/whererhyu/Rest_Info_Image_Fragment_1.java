...
public class Rest_Info_Image_Fragment_1 extends Fragment {
	...
	public static Rest_Info_Image_Fragment_1 newInstance(int sectionNumber) {
		Rest_Info_Image_Fragment_1 fragment = new Rest_Info_Image_Fragment_1();
	...
	public Rest_Info_Image_Fragment_1() {
	}
			...
			try {
				...
				if (jsonMainNode != null) {
					for (int i = 0; i < jsonMainNode.length(); i++) {
						...
						String temp_s = jsonChildNode.getString("image1");
